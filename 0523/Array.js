...
console.log(index);
console.log(colors.indexOf("black")); // 찾을때 없으면 -1 리턴
...
const jopArray = persons.map((p) => p.jop);
console.log(jopArray);
